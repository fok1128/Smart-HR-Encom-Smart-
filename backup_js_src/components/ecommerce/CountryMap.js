...
var CountryMap = function (_a) {
    var mapColor = _a.mapColor;
    return ((0, jsx_runtime_1.jsx)(core_1.VectorMap, { map: world_1.worldMill, backgroundColor: "transparent", markerStyle: {
            initial: {
                fill: "#465FFF",
        ...
        ], zoomOnScroll: false, zoomMax: 12, zoomMin: 1, zoomAnimate: true, zoomStep: 1.5, regionStyle: {
            initial: {
