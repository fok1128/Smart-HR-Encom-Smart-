...
hint = "", // Default hint text
    ...
    return (_jsxs("div", { className: "relative", children: [_jsx("textarea", { placeholder: placeholder, rows: rows, value: value, onChange: handleChange, disabled: disabled, className: textareaClasses }), hint && (_jsx("p", { className: `mt-2 text-sm ${error ? "text-error-500" : "text-gray-500 dark:text-gray-400"}`, children: hint }))] }));
};
